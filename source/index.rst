...
- The second section is the developer section wich is under heavy development and will probably never be completed. The developer section is splitted in three subsections: `Developer <https://doc.a3-audio.com/development/developer.html>`_ (about the code), `Assembly <https://doc.a3-audio.com/development/assembly.html>`_ (about hardware), and `Configuration <https://doc.a3-audio.com/development/configuration.html>`_ (setup operation systems).
